...
raise Exception('component ui not implemented yet.')


#==============================================================================
# make a UI
#==============================================================================
parser = argparse.ArgumentParser(prog='run_cufflinks',
                                 description = ''' runs cufflinks program within
                                                   the cufflinks suite''')
...
# lots more options need to go in here...
